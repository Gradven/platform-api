package com.channelsharing.hongqu.portal.api.config;
...
public class SwaggerConfig extends WebMvcConfigurerAdapter {
	...
	private String basePackage = "com.channelsharing.hongqu.portal.api.controller";
	...
	private ApiInfo apiInfo() {
		return new ApiInfoBuilder()
				// 页面标题
				.title("Hongqu-门户接口  使用 Swagger2 构建RESTful API")
				// 创建人
