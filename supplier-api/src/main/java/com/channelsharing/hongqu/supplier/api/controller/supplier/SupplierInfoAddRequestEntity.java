 ...
 */
@Data
public class SupplierInfoAddRequestEntity {

	@ApiModelProperty(value = "供应商名称", example="某某网络科技有限公司")
	@Length(min=1, max=32, message="供应商名称长度必须介于 1 和 32 之间")
	...
	@ApiModelProperty(value = "客服QQ号", example="88888888")
	@Length(min=0, max=24, message="客服QQ号长度必须介于 0 和 24 之间")
	private String serviceQQ;   // 客服QQ号
	
	@ApiModelProperty(value = "退换货地址", example="浙江杭州余杭区xx街道xx号")
