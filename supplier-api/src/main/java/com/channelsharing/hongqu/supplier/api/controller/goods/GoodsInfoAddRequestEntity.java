 ...
 */
@Data
public class GoodsInfoAddRequestEntity {
	...
	@ApiModelProperty(value = "商品短简介", example="商品短简介商品短简介")
	@Length(min=0, max=128, message="商品短简介长度必须介于 0 和 128 之间")
	public String shortDescription;		// 商品短简介
